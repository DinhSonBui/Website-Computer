<?php
   ...
   // Add a Unicode font (uses UTF-8)
	...
	$pdf->Cell($width_cell[5],10,number_format($row['quantify'] * $row['price_sale']),1,1,'C',$fill);
	$fill = !$fill;
	$total = $total + $row['quantify'] * $row['price_sale'];
	}
	$pdf->Write(10,'Tổng giá : '); $pdf->Write(10,$total);
	$pdf->Ln(10);
	$pdf->Write(10,'Cảm ơn bạn đã đặt hàng tại website TTG-SHOP của chúng tôi.');
	$pdf->Ln(10);
    $pdf->Ln(10);
